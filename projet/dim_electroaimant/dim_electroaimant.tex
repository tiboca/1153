...
champ magnétique assez fort. Nous avons fixé ce nombre à \numprint{420} spires car c'est le nombre de spires dont nous 
avons besoin pour avoir un champs magnétique convenable.  Nous ne l'avons pas encore calculé mais on connait l'ordre de
grandeur.
...
Pour céer un champ magnétique plus fort, nous avons réduit l'entrefer à $\unit{7}{\milli\meter}$.
...
y déposer dffiérentes masse, et finalement mesurer son élongation grâce à la formule $mg=kx$
